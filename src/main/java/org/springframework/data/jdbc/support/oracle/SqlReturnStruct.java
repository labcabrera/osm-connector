 ...
 * The target class specified in the constructor must implement java.sql.SQLData.
 *
 * <p>
 * A usage example from a StoredProcedure:
 *
 * <pre class="code">
 * proc.declareParameter(new SqlOutParameter("return", OracleTypes.STRUCT, "ACTOR_TYPE", new SqlReturnArray()));
 * </pre>
 *
...
public class SqlReturnStruct implements SqlReturnType {
	 ...
	 * out parameter processing and it's not accessed by appplication code directly.
	 */
