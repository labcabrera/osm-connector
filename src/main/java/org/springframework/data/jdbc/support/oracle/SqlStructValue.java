...
public class SqlStructValue<T> extends AbstractSqlTypeValue {
	...
	/**
	 * Constructor that takes two parameters, the Object value passed in to the statement and the default type name to
	 * be used when the context where this class is used is not aware of the type name to use.
	 *
	 * @param source the Object containing the values to be mapped to the STRUCT.
	...
	/**
	 * Constructor that takes two parameters, the Object value passed in to the statement and the {@link StructMapper}
	 * to be used
	 * @param source the Object containing the values to be mapped to the STRUCT.
	...
	/**
	 * Constructor that takes three parameters, the Object value passed in to the statement, the {@link StructMapper} to
	 * be used and the default type name to be used when the context where this class is used is not aware of the type
	 * name to use.
	 * 
	 * @param source the Object containing the values to be mapped to the STRUCT.
	 * @param mapper the mapper
	...
	/**
	 * The implementation for this specific type. This method is called internally by the Spring Framework during the
	 * out parameter processing and it's not accessed by application code directly.
	 * @see org.springframework.jdbc.core.support.AbstractSqlTypeValue
	 */
